...
public class ChildStream {
	...
	public static void main(String[] args) {
		...
		double ageMoyen = enfants.stream()
				.mapToInt(c -> c.getAge())
				.average()
				.getAsDouble();
		...
		boolean auMoinsUnEnfantADepasseLAge = enfants
				.stream()
				.anyMatch(c -> c.getAge() > minAge);
		...
		Child enfantLePlusVieux = enfants.stream()
				.max((c1, c2) -> c1.getAge() - c2.getAge()).orElse(null);
