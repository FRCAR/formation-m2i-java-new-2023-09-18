...
public class LocalDateTimeExercice {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			System.err.println("Il faut lancer ce programme avec une date en argument (format AAAA-MM-JJ)");
			return;
		}
		...
		try {
			...
			System.err.println("Impossible de transformer la date : " + dateArg + " . Cause : ");
